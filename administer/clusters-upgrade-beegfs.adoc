...
NOTE: 如果您要升級到 BeeGFS v8，請參閱 link:clusters-upgrade-beegfs-v8.html["升級至 BeeGFS v8"] 相關步驟。
...
| 7.4.6 | 8.0 | 是的 | 請按照 link:clusters-upgrade-beegfs-v8.html["升級至 BeeGFS v8"] 操作步驟中的說明進行升級。 


| 7.4.6 | 8.1 | 是的 | 請按照 link:clusters-upgrade-beegfs-v8.html["升級至 BeeGFS v8"] 操作步驟中的說明進行升級。 


| 7.4.6 | 8.2 | 是的 | 請按照 link:clusters-upgrade-beegfs-v8.html["升級至 BeeGFS v8"] 操作步驟中的說明進行升級。 
|===
