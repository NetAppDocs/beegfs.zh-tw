...
NOTE: 某些韌體更新可能需要重新開機才能套用更新。請參閱 link:https://networking-docs.nvidia.com/mftswum/4201/mlxfwreset-loading-firmware-on-5th-generation-devices-tool#id-(4.20.1)mlxfwreset–LoadingFirmwareon5thGenerationDevicesTool-mlxfwresetLimitations["NVIDIA 的 mlxfwreset 限制"^] 相關指南。如果需要重新開機，請執行重新開機，而非重設介面卡。
