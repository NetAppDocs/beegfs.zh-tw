...
----
點擊 link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_cluster_building_blocks/beegfs_ha_building_block_cluster_1/group_vars/meta_01.yml["請按這裡"^] 查看代表 BeeGFS 元資料服務的完整清單檔案範例。
